...
const HomeProjects = () => {
  ...
  return (
    <div className="bg-theme-primary w-full py-32" id="projects">
          ...
          {homeProjects.map((project, index) => (
            ...
            >
              ...
              <div className="flex flex-col flex-1 p-5 gap-3">
                ...
                {/* Divider */}
                <div className="w-full h-px mt-1" style={{ background: "var(--border-color)" }} />
              ...
              {/* Bottom accent bar */}
              <div className="absolute bottom-0 left-0 w-full h-0.5 bg-[#44A076] origin-left scale-x-0 group-hover:scale-x-100 transition-transform duration-500" />
            </motion.div>
          ))}
        </div>
