...
const Education = () => {
  ...
  return (
    <div className="bg-[#10121B] py-24 w-full" id="education">
      <div className="max-w-[1200px] mx-auto px-4">
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="relative bg-[#1A2235]/40 backdrop-blur-xl border border-gray-800/60 rounded-[2rem] p-8 md:p-12 overflow-hidden group hover:border-[#44A076]/30 transition-all duration-500"
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 relative z-10">
            ...
            <div className="lg:col-span-5 space-y-8 text-left">
              <div className="w-16 h-16 rounded-2xl bg-[#10121B] border border-gray-800 flex items-center justify-center text-[#44A076] group-hover:bg-[#44A076] group-hover:text-white transition-all duration-500">
              ...
              <div>
                ...
                <div className="space-y-1 mt-4">
                  <p className="text-gray-400 text-sm font-mono">
                    Academic Period:{" "}
                    <span className="text-white">2020 – 2025</span>
                  </p>
                  <p className="text-gray-400 text-sm font-mono">
                    CGPA: <span className="text-white">3.57 / 4.00</span>
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-y-4 gap-x-8 text-left">
                {coursework.map((course, idx) => (
                  <div key={idx} className="flex gap-4 items-start group/item">
                    ...
                    <p className="text-gray-400 group-hover/item:text-white transition-colors text-[15px] md:text-[16px] leading-snug">
                      {course}
                    </p>
                  </div>
                ))}
